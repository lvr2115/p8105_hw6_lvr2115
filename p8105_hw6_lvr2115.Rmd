...
#significant coefficients per pvalue: babysex2, bhead,blength,delwt,gaweeks
```

```{r compare to other 2 models}
fit2 = lm(bwt~blength+gaweeks, data=birthweight)

fit3 = lm(bwt~bhead*blength+bhead*babysex+blength*babysex, data=birthweight)
```
